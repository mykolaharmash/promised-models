...
var Attribute = Inheritable.inherit({
    __constructor: function (initValue) {
        ...
        this.value = this.toAttributeValue(setValue);
        this.commit();
    },
    ...
    isEqual: function (value) {
        return this.value === this.toAttributeValue(value);
    },
    ...
    getLastCommitted: function (branch) {
        branch = branch || this.DEFAULT_BRANCH;
        return this.fromAttributeValue(this._cachBranches[branch]);
    },
    ...
    set: function (value) {
        if (value === null) {
            ...
            this.value = this.toAttributeValue(value);
            this._isSet = true;
            this._emitChange();
        }
    },
    ...
    get: function () {
        ...
        return this.fromAttributeValue(this.value);
    },
     ...
     */
    parse: function () {
        return this.toAttributeValue.apply(this, arguments);
    },
