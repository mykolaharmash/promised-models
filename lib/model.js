...
var EventEmitter = require('eventemitter3'),
    ...
    Model = Inheritable.inherit({
        ...
        __constructor: function (id, data) {
            ...
            modelAttributes = this.__self.attributes || {};
            ...
            this.attributes = Object.keys(modelAttributes).reduce(function (attributes, name) {
                ...
                if (attributes[name].isId) {
                    this._idAttribute = attributes[name];
                }
            ...
            // todo: remove after removing id property support
            this.id = this._idAttribute.get();
            this.on('change:' + this._idAttribute.name, function () {
                this.id = this._idAttribute.get();
            }, this);
        ...
        /**
         * @param {('toJSON'|'getLastCommitted')} serializeMethod
         * @param {...*} [args]
         * @returns {Object}
         */
