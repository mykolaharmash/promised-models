...
var EventEmitter = require('eventemitter3'),
    ...
    Model = Inheritable.inherit({
        ...
        getLastCommitted: function (branch) {
            return Object.keys(this.attributes).reduce(function (result, name) {
                if (!this.attributes[name].internal) {
                    result[name] = this.attributes[name].getLastCommitted(branch);
                }
                return result;
            }.bind(this), {});
        },
